...
@section('content')
    @component('admin.components.panel')
        @slot('title', 'Crear Responsable')
        {!! Form::open([
            'route' => 'admin.responsables.store',
            'method' => 'POST',
            'id' => 'form_crear_responsables',
        ...
        <div class="form-group">
            <div class="col-md-5 col-md-offset-3">
                {{ link_to_route('admin.responsables.index',"Cancelar", [], ['class' => 'btn btn-info']) }}
                {!! Form::submit('Crear Responsable', ['class' => 'btn btn-success']) !!}
            </div>
        </div>
        {!! Form::close() !!}
    @endcomponent
...
@push('functions')
    <script type="text/javascript">
        var form = $('#form_crear_responsables');
        $(form).parsley({
            trigger: 'change',
