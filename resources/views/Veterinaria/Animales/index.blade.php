    ...
    <script type="text/javascript">
        $(document).ready(function () {
                ...
                "columns": [
...

                    {
                        defaultContent:
                            ...
                            '@can('MODIFICAR_ANIMALES')<a href="javascript:;" class="btn btn-simple btn-info btn-sm edit" data-toggle="confirmation"><i class="fa fa-pencil"></i></a>@endcan',
                        data: 'action',
                        name: 'action',
                        title: 'Acciones',
                        orderable: false,
            ...
            table.on('click', '.remove', function (e) {
                ...
                var route = '{{ url('admin/animales/') }}' + '/' + dataTable.pk_id_animales;
                var type = 'DELETE';
                dataType: "JSON",
            ...
            table.on('click', '.edit', function (e) {
                ...
                $tr = $(this).closest('tr');
                var dataTable = table.row($tr).data();
                var route = '{{ url('admin/animales/') }}' + '/' + dataTable.pk_id_animales + '/edit';
