...
@slot('title', 'Modificar Animales')
{!! Form::model($animales, [ 'route' => ['admin.animales.update', $animales], 'method' => 'PUT', 'id' => 'form_modificar_animales',
'class' => 'form-horizontal form-label-lef', 'novalidate' ])!!}
@include('Veterinaria.Animales._form')
<div class="ln_solid"></div>
<div class="form-group">
    <div class="col-md-6 col-md-offset-3">
        {{ link_to_route('admin.animales.index',"Cancelar", [], ['class' => 'btn btn-info']) }} {!! Form::submit('Modificar Animales',
...
@push('functions')
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            var form = $('#form_modificar_animales');
            $(form).parsley({
                trigger: 'change',
            ...
            form.submit(function (e) {
                ...
                $.ajax({
                    ...
                    success: function (response, NULL, jqXHR) {
                        ...
                        window.location.href = " {{ route('admin.animales.index')}} ";
                    },
                    error: function (data) {
                        console.log(data);
