...
@section('content') @component('admin.components.panel') @slot('title', 'Usuarios')
    <div class="col-md-12">
        <div class="actions">
            <a href="{{ route('admin.usuarios.create') }}" class="btn btn-info">
                <i class="fa fa-plus"></i> Agregar Usuario</a></div>
    </div>
    <br>
    <br>
    <br>
    <div class="col-md-12">
        ...
        'id', 'Nombre', 'Apellido','Edad','Email', 'Direccion','Telefono','Roles',
        ...
        $(document).ready(function () {
            ...
            table = $('#usuario-table-ajax').DataTable({
                ...
                "columns": [
                    ...
                    {data: 'lastname', name: 'Apellido', className: "all"},
                    {data: 'age', name: 'Edad', className: "all"},
                    {data: 'email', name: 'Email', className: "min-phone-l"},
                    {data: 'address', name: 'Direccion', className: "min-phone-l"},
                    {data: 'phone', name: 'Telefono', className: "min-phone-l"},
